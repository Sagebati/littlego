...
@click.option("-e", "--epoch", default=5000)
@click.option("--report-freq", default=500)
@click.option("--data-size", default=25000)
def supervised(path_dataset, board_size, epoch, report_freq, data_size):
    # Supervised training
